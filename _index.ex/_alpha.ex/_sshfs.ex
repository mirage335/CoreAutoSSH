...
mkdir -p "$testScriptAbsoluteFolder"/_arc/_sshfs/root
mkdir -p "$testScriptAbsoluteFolder"/_arc/_sshfs/home
mkdir -p "$testScriptAbsoluteFolder"/_arc/_sshfs/user

#Launch in directory with needed resources.
"$cautosshLocation" "$commandName" "$SSHUSER""$machineName":/ "$testScriptAbsoluteFolder"/_arc/_sshfs/root "$@"
